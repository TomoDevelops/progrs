...
export const AppearanceSection = React.forwardRef<
  HTMLElement,
          ...
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleSettingChange(
                  "colorScheme",
                  value as AppearanceSettings["colorScheme"],
                )
              }
            >
              <SelectTrigger>
                <SelectValue>
                  <div className="flex items-center gap-2">
                    <div
                      className={`h-3 w-3 rounded-full bg-${appearanceSettings.colorScheme}-500`}
                    ></div>
                    <span className="capitalize">
