...
export const LanguageSection = React.forwardRef<HTMLElement, LanguageSectionProps>(
  ({ id }, ref) => {
  ...
  const [originalSettings, setOriginalSettings] = useState<LanguageSettings>(languageSettings)
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-3">
                ...
                <Select
                  ...
                  onValueChange={(value) => handleSettingChange('dateFormat', value as LanguageSettings['dateFormat'])}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-3">
                ...
                <Select
                  ...
                  onValueChange={(value) => handleSettingChange('timeFormat', value as LanguageSettings['timeFormat'])}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-3">
                ...
                <Select
                  ...
                  onValueChange={(value) => handleSettingChange('firstDayOfWeek', value as LanguageSettings['firstDayOfWeek'])}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-3">
                ...
                <Select
                  ...
                  onValueChange={(value) => handleSettingChange('measurementSystem', value as LanguageSettings['measurementSystem'])}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
