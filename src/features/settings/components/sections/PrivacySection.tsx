...
export const PrivacySection = React.forwardRef<
  HTMLElement,
  PrivacySectionProps
>(({ id }, ref) => {
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleSettingChange("workoutDataSharing", checked)
                    }
                    disabled={isUpdating}
                  />
                </div>
            ...
            <div className="space-y-4">
              <div className="space-y-4">
                ...
                <div className="bg-muted/50 rounded-lg p-4">
                  <h4 className="mb-2 font-medium">Data Retention</h4>
                  <div className="text-muted-foreground space-y-2 text-sm">
                    <p>
                      • Workout data: Retained indefinitely unless you delete
                      your account
                    </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-muted-foreground mt-1 text-sm">
                        Permanently delete all your workout data, progress, and
