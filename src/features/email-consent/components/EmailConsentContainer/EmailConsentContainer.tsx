...
export function EmailConsentContainer() {
  ...
  const { handleSocialAuthWithConsent, isLoading: authLoading, error: authError } = useAuth();
      ...
      <div className="w-full max-w-2xl space-y-8">
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="pb-6 text-center">
            ...
            <CardTitle className="text-2xl font-bold">Email Permission Request</CardTitle>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 mt-1">
                  <Shield className="h-4 w-4 text-green-600" />
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900">Account Security</h3>
                  <p className="text-sm text-gray-600 mt-1">
                    We&apos;ll send you important security notifications, password reset emails, 
                    and account verification messages to keep your account safe.
                  </p>
                </div>
              </div>

              <div className="flex items-start space-x-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 mt-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    ...
                    important changes to our service, or maintenance notifications.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border-t pt-6">
              <div className="flex items-start space-x-3">
                ...
                <label htmlFor="email-consent" className="text-sm text-gray-700 leading-relaxed cursor-pointer">
                  I understand and consent to receiving emails from Progrs for account security, 
                  service updates, and essential communications. I understand that I can 
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              <Button
                ...
                disabled={!hasConsented || isSubmitting || authLoading || !provider}
                className="flex-1"
              >
                {isSubmitting || authLoading ? "Processing..." : "I Agree & Continue"}
              </Button>
              <Button
                variant="outline"
                onClick={() => router.back()}
        ...
        <div className="text-center text-xs text-gray-500">
          By continuing, you acknowledge that you have read and understood our email practices.
        </div>
      </div>
    </div>
  );
